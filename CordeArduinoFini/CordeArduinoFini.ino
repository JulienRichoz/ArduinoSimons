...
int led1 = 30; //LED rouge
int led2 = 31; //LED verte
int led3 = 32; //LED bleue
int led4 = 33; //LED jaune
int bouton1 = 34; //Bouton rouge
int bouton2 = 35; //Bouton vert
int bouton3 = 36; //Bouton bleu
int bouton4 = 37; //Bouton jaune
int speaker = 50; //Speaker
